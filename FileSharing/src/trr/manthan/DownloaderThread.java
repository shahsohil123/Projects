...
public class DownloaderThread extends Thread
{
        ...
        // instance variables
        private Download parentActivity;
         ...
         */
        public DownloaderThread(Download inParentActivity, String inUrl)
        {
                downloadUrl = "";
                if(inUrl != null)
                {
        ...
        public void run()
        {
                ...
                msg = Message.obtain(parentActivity.activityHandler,
                              Download.MESSAGE_CONNECTING_STARTED,
                                0, 0, downloadUrl);
                ...
                try
                {
                        ...
                        msg = Message.obtain(parentActivity.activityHandler,
                        		Download.MESSAGE_DOWNLOAD_STARTED,
                        ...
                        while(!isInterrupted() && (bytesRead = inStream.read(data, 0, data.length)) >= 0)
                        {
                                ...
                                msg = Message.obtain(parentActivity.activityHandler,
                                		Download.MESSAGE_UPDATE_PROGRESS_BAR,
                                                totalReadInKB, 0);
                                parentActivity.activityHandler.sendMessage(msg);
                        }
                        ...
                        else
                        {
                                // notify completion
                                msg = Message.obtain(parentActivity.activityHandler,
                                		Download.MESSAGE_DOWNLOAD_COMPLETE);
                                parentActivity.activityHandler.sendMessage(msg);
                        }
                }
                catch(MalformedURLException e)
                {
                        ...
                        msg = Message.obtain(parentActivity.activityHandler,
                        		Download.MESSAGE_ENCOUNTERED_ERROR,
                                        0, 0, errMsg);
                        parentActivity.activityHandler.sendMessage(msg);
                }
